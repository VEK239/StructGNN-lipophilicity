...
def tensorise_smiles(smiles, args, max_degree=5, max_atoms=None):
...
#         # Get atom features
#         f_atoms = [atom_features_for_substructures(atom) for atom in mol.get_atoms()]
...
#                 f_bond = bond_features_for_substructures(bond.get_rdkit_bond())
#                 f_bonds.append(self.f_atoms[a1] + f_bond)
#                 f_bonds.append(self.f_atoms[a2] + f_bond)
